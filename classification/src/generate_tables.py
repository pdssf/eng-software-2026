...
def gen_table_4():
  ...
  with open(table_filename, "w") as f:
    ...
    gen_table_row(f, "nn10", desired_metrics, "Golden Features kNN (with k = 10)")
    gen_table_row(f, "nn5", desired_metrics, "Golden Features kNN (with k = 5)")
    gen_table_row(f, "nn3", desired_metrics, "Golden Features kNN (with k = 3)")
    gen_table_row(f, "nn", desired_metrics, "Golden Features kNN (with k = 1)")
